...
enum Constants {
    ...
    static let AUTH0_DOMAIN = "YOUR_TENANT.auth0.com" // Replace in Auth0 session
    static let AUTH0_CLIENT_ID = "YOUR_CLIENT_ID" // Replace in Auth0 session
    static let AUTH0_AUDIENCE = "YOUR_API_IDENTIFIER" // Replace in Auth0 session
